    ...
    <div className="flex items-center space-x-3">
      ...
      <div>
        <div className="flex items-center gap-1.5">
          ...
          <Badge variant={agent.role === "moderator" ? "default" : "secondary"} className="text-xs px-1.5 py-0">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-1.5">
            {agent.expertise.map((expertise) => (
              <Badge key={expertise} variant="outline" className="text-xs px-1.5 py-0">
                {expertise}
              </Badge>
            ))}
          </div>
...
export function AgentCard({
  ...
  return (
    <Card className={cn("w-full hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors", className)}>
